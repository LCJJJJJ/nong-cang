...
const roleCards = [
  ...
  },
  {
    ...
    modules: ['仓库管理', '入库管理', '出库管理', '实时库存查询', '库存盘点管理', '预警中心', '消息中心', '农产品基础信息管理（只读）'],
  },
  {
    roleName: '库存管理员',
    description: '负责库存准确性、库存调整、盘点与库存治理。',
    warehouseRule: '必须指定一个仓库',
    modules: ['实时库存查询', '库存流水', '库存调整管理', '库存盘点管理', '预警中心', '消息中心', '农产品基础信息管理（只读）'],
  },
  {
    roleName: '质检管理员',
    description: '负责质检、异常库存和损耗处理。',
    warehouseRule: '必须指定一个仓库',
    modules: ['质检单管理', '异常库存管理', '损耗登记管理', '预警中心', '消息中心', '农产品基础信息管理（只读）', '仓库管理（只读）'],
  },
]
